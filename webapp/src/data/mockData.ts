...
export const defaultGuideContent: GuideContentStore = {
  version: 4,
  places: [...restaurantPlaces, ...wellnessPlaces, ...routePlaces, ...transportPlaces, ...atmPlaces],
  ...
  home: {
    popularPlaceIds: ['r-1', 'r-3', 'w-1', 'route-1', 'transport-1', 'atm-1'],
    featuredCategoryIds: ['restaurants', 'wellness', 'routes', 'transport', 'atm', 'culture'],
